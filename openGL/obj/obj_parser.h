...
//All typedef altered to fix those aggravating typedef errors I
//always get.
...
typedef struct obj_face obj_face;
...
typedef struct obj_sphere obj_sphere;
...
typedef struct obj_plane obj_plane;

struct obj_vector
{
	double e[3];
};
typedef struct obj_vector obj_vector;
...
typedef struct obj_material obj_material;
...
typedef struct obj_camera obj_camera;
...
typedef struct obj_light_point obj_light_point;
...
typedef struct obj_light_disc obj_light_disc;
...
typedef struct obj_light_quad obj_light_quad;
...
typedef struct obj_growable_scene_data obj_growable_scene_data;
...
typedef struct obj_scene_data obj_scene_data;
